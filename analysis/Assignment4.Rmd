...
### Skill Gain across verticals from the year 2015-2019
...
### Skill Loss across verticals from the year 2015-2019
...
- Industries like *Finance* - __Venture Capital and Private Equity__ and *Tech Industry* - __Computer and Network Security, Information Services, Internet__ have flourished consistently over the years with highest number of arrivals from other industries. _E-Learning_ and _Outsourcing/Offshoring_ is an upcoming industry with increasing arrivals.
- In *Business Skill category*, __Debt Collection skill__ has seen maximum skill *gain*, whereas __Investor Relations, Tax Accounting and Partner Development__ has seen maximum skill *loss*
- In *Disruptive Tech Skill category*, __Fintech sector__ has seen maximum skill *gain*, whereas __Aerospace Engineering and Material Science__ has seen maximum skill *loss*
- In *Soft Skill category*, __Persuasion skills__ has seen maximum skill *gain* with __Communication__ showing a continuous downward trend
- *Specialised Industry* category shows an upward trend in skills related to sciences
- *Tech Skills category* shows a consistent upward trend for __Data-Driven Analytics__ whereas __Computer Graphics and Social Media__ show downward trend 
