...
- In *Business Skill sector*, maximum arrivals are in __Debt Collection skill__
- In *Disruptive Tech Skill sector*, maximum and consistent arrivals are in __Fintech sector__. Also __Aerospace Engineering__ showing a consistent trend of departures
-In *Soft Skill sector*, __Persuasion skills__ have shown consistency with maximum arrivals. These skills are the need of the hour with increasing sales and marketing trend. 
- *Specialised Industry* sector shows an upcoming trend in skills like __Nuclear Physics, Oral Comprehension & Psychiatry__
- *Tech Skills sector* shows a consistent trend for __Data-Driven Analytics__, with __Web hosting__ being next in line. 
