...
### Top Skill Gains in the year 2019
...
talentmig_skill_summary_11 <- talentmig_skill_summary_1 %>% 
  filter(Year %in% "2019", netmigration > 0) %>% 
  group_by(skill_group_category) %>%
  slice_max(netmigration, n = 5)

treemap(talentmig_skill_summary_11, index=c("skill_group_category","skill_group_name"),  vSize="netmigration", type="index",
    fontsize.labels=c(15,12),                # size of labels. Give the size per level of aggregation: size for group, size for subgroup, sub-subgroups...
    fontcolor.labels=c("black","black"),    # Color of labels
