...
Most high-skilled workers, in particular those with management, research, and leadership skills, choose to migrate to a different country with more lucrative opportunities. In Figures \@ref(fig:tech) and \@ref(fig:business) we observe the top 5 Tech skill gains  and Business skill gains due to migration to high income countries from 2015-2109
...
- In traditional business occupations like Bookkeeping, Tax Accounting, Economics have shown a downward trend, concluding that there are fewer people with business skills opting to migrate to another country in search of jobs. <br>
- People with tech skills are choosing to migrate to high income countries are mainly skilled in domains like Scientific Computing and Mobile Application Development which have shown a steep upward trend. 
